...
<html>
	<head>
		<title>About Reba Wek-Lake | Santa Clarita, CA</title>
			...
			<section id="twoAboutReba" class="main styleContentPage">
				<div class="container">
					<div class="row gtr-150">
						<div class="col-12">
							<header class="">
								<h1 style="text-align: center;">Meet Your Trainer</h1>
